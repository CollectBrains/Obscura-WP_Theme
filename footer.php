		...
		<div id="second" class="widget-area">
			<div id="twitter-2" class="widget widget_twitter">
				...
				<div id="twitter-wrapper">
					<div id="twitter"></div>
					<span class="username"><a href="#">→ Follow twitter</a></span>
				</div>
			</div>
...
<div class="site-generator-wrapper">
	<div class="site-generator">Copyright Obscura 2012. Design by <a href="http://bayguzin.ru/">bayguzin</a>. All rights reserved.</div>
</div>
<!-- End Footer -->
</div><!-- #page -->
